...
# MAX Frequency 20 Hz
leftMotorPWM = io.PWM(leftMotor_PWM_pin,200)# Frequency pwm max for rpi = 8000Hz 
rightMotorPWM = io.PWM(rightMotor_PWM_pin,200)
...
def setuv(state):
   if state == 1 :
      print('----------( WARNING FOR UVC RADIATION !! )---------')
      print('------------( UVC WILL ON IN 3 SECOND )------------')
      io.output(led_red,io.HIGH)
      time.sleep(0.5)
      io.output(led_red,io.LOW)
      time.sleep(0.5)
      print('------------( UVC WILL ON IN 2 SECOND )------------')
      io.output(led_red,io.HIGH)
      time.sleep(0.5)
      io.output(led_red,io.LOW)
      time.sleep(0.5)
      print('------------( UVC WILL ON IN 1 SECOND )------------')
      io.output(led_red,io.HIGH)
      time.sleep(0.5)
      io.output(led_green,io.LOW)
      time.sleep(0.5)
      io.output(uvc,io.HIGH)
      io.output(led_red,io.HIGH)
      print('-------------------( UVC IS ON )-------------------')
   else:
      io.output(uvc,io.LOW)
      io.output(led_red,io.LOW)
      print('-------------------( UVC IS OFF )------------------')
